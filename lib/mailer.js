...
<div style="max-width:520px;margin:40px auto;background:#fff;border-radius:12px;border:1px solid #E5E7EB;overflow:hidden;">
  ...
  <!-- Header -->
  <div style="background:#0F1117;padding:28px 32px;display:flex;align-items:center;">
    <div style="width:36px;height:36px;background:#fff;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;margin-right:12px;">
...
async function sendOrderConfirmation(order, pdfBuffer) {
  ...
  console.log(`[mailer] Email envoyé à ${order.customerEmail}`);
}
